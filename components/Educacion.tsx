    ...
    return (
        <div className='mt-8'>
            <div className='text-center flex flex-col items-center justify-center mx-auto'>
                ...
                <p className='w-[50%] mt-4 color_letra'>Mi trayectoria educativa ha sido el cimiento de mi carrera, proporcionándome las habilidades y conocimientos necesarios para enfrentar los desafíos del mundo tecnológico.</p>
            </div>
